...
/**
 * Milestone 4 Empirical Adversarial Concurrency & Preflight Stress Suite (m4_challenger_1)
 *
 * Focus areas:
 ...
 */
describe('Milestone 4 Empirical Adversarial Concurrency & Preflight Suite (m4_challenger_1)', () => {
  const baseChannel = {
    id: 'chan-adversarial',
