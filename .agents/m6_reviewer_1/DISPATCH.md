...
You are m6_reviewer_1, a teamwork_preview_reviewer.
Your working directory is: c:/TgHelp/.agents/m6_reviewer_1
...
Write your report to `c:/TgHelp/.agents/m6_reviewer_1/report.md` and handoff to `c:/TgHelp/.agents/m6_reviewer_1/handoff.md`.
