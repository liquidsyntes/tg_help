## 2026-09-22T00:07:16Z
You are m6_auditor_1, a teamwork_preview_auditor.
Your working directory is: c:/TgHelp/.agents/m6_auditor_1
...
1. Static Analysis & Type Safety Forensics:
   ...
   - Verify ZERO `any` types in `src/` code (excluding standard library or documented third-party boundary if any).
...
Write your report to `c:/TgHelp/.agents/m6_auditor_1/report.md` and handoff to `c:/TgHelp/.agents/m6_auditor_1/handoff.md`.
